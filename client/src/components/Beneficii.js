      ...
      <Row className="tabel">
        <Col className="coloana">
          ...
          <ol className="gradient-list">
            ...
            <li className="color-black">
              Carnet de donator ce iti aduce diverse avantaje.
            </li>
            <li className="color-black">
              O zi libera de la locul de munca in ziua donarii.
            </li>
          </ol>
        </Col>
        <Col className="coloana">
          ...
          <ol class="gradient-list">
            ...
            <li className="color-black">
              Este recomandat sa consumati o mancare usoara si sa va hidratati
              inainte de donare.
            </li>
            <li className="color-black">
