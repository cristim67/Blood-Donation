    ...
    return (
      <div className='formulare'>
        <div className="auth-form-container SpatiereRegister">
            <h2 className="SpatiereRegister">Verificare Email - {localStorage.getItem('email').slice(1,localStorage.getItem('email').length-1)}</h2>
        <form className="register-form" onSubmit={handleSubmit}>
            ...
            <input value={code} name="code" onChange={(e) => setCode(e.target.value)} id="code" placeholder="code" required/>
