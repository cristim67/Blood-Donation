    ...
    return (
      <div className='formulare'>
        ...
        <form className="register-form" onSubmit={handleSubmit}>
            ...
            <input value={name} name="name" onChange={(e) => setName(e.target.value)} id="name" placeholder="Nume" required/>
            <label htmlFor="telefon">Telefon</label>
            <input value={telefon} name="telefon" onChange={(e) => setTelefon(e.target.value)} id="telefon" placeholder="Telefon" required/>
            <label htmlFor="email">Email</label>
            <input value={email} onChange={(e) => setEmail(e.target.value)}type="email" placeholder="nume@stud.etti.upb.ro" id="email" name="email" required/>
            <label htmlFor="password">Parola</label>
            <input value={pass} onChange={(e) => setPass(e.target.value)} type="password" placeholder="********" id="password" name="password" required/>
            <label htmlFor="password">Confirmare Parola</label>
            <input value={passconfirm} onChange={(e) => setPassConfirm(e.target.value)} type="password" placeholder="********" id="cpassword" name="cpassword" required/>
